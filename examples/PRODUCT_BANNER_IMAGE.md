# BANNER IMAGE - Product Context

This example demonstrates how to request banner ads in the product context.
    ...
    "{PLACEMENT_NAME}": [
        {
            ...
            "click_url": "https://events.newtail-media.newtail.com.br/v1/beacon/click/{AD_ID}?publisher_id={PUBLISHER_ID}&ad_type=banner&campaign_id={CAMPAIGN_ID}&pname=displays&ad_size={ASSET_SIZE}&context=product&product_id={PRODUCT_ID}&channel=site&event_id=199981cc-0266-491c-8ece-d5443068b19b&request_id=bd996431-5057-4fb2-a0e9-d8af84b23fde&session_id={SESSION_ID}&user_id={USER_ID}&requested_at=1751413372239&sign=6248131ddfaa5b8553c1ed9d78fdec5923a53f201973ea2f23879d084d2ffbcb",
