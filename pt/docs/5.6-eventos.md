...
*   **Quando enviar:** `impression_url` quando o criativo for renderizado; `view_url` quando o criativo estiver visível (se você medir viewability); `click_url` no clique do usuário.
